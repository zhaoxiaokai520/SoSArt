...
public class AB_HeroObBuild : AB_HeroBuildBase
{
	...
	private void CreatePacketBuild()
	{
		...
		for (int i = 0; i < directories.Length; i++)
		{
			...
			{
				this.mHeroBattleBase = new AB_HeroPacketBuild(ABAssetBuildMgr.E_ABBUNLDE_TYPE.E_CHARACTER, text + "_ob", 0);
			...
			{
				AB_HeroPacketBuild aB_HeroPacketBuild = new AB_HeroPacketBuild(ABAssetBuildMgr.E_ABBUNLDE_TYPE.E_CHARACTER, directoryInfo.Name + "_ob", 0);
