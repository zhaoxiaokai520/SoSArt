...
{
	public ABAssetBuildMgr.E_ABBUNLDE_TYPE meType = ABAssetBuildMgr.E_ABBUNLDE_TYPE.E_ILLEGAL;

	public string msBundleName = "";

	public AB_HeroBuildBase mHeroBuild;

	private List<ABCmdBase> mCmdList = new List<ABCmdBase>();

	private AssetGroupInfo_t mAssetGroupInfo;

	private ABAssetBuildMgr.AssetBundleBuildEX mAssetBundle;
	...
	public void AddCmd(ABCmdBase cmd)
	{
	...
	{
		this.mAssetBundle = ABAssetBuildMgr.GetAssetBundleBuild(this.meType, this.msBundleName);
	...
	private int ABType2ResTag(ABAssetBuildMgr.E_ABBUNLDE_TYPE eType)
	{
		switch (eType)
		{
		case ABAssetBuildMgr.E_ABBUNLDE_TYPE.E_SHADER:
			return 10;
		case ABAssetBuildMgr.E_ABBUNLDE_TYPE.E_TEXTURE:
			return 8;
		case ABAssetBuildMgr.E_ABBUNLDE_TYPE.E_EFFECT:
			return 11;
		case ABAssetBuildMgr.E_ABBUNLDE_TYPE.E_UI:
			return 3;
		case ABAssetBuildMgr.E_ABBUNLDE_TYPE.E_SCENE:
			return 3;
		case ABAssetBuildMgr.E_ABBUNLDE_TYPE.E_CHARACTER:
			return 2;
		case ABAssetBuildMgr.E_ABBUNLDE_TYPE.E_ACTION:
			return 5;
		case ABAssetBuildMgr.E_ABBUNLDE_TYPE.E_ACTORINFO:
			return 6;
		case ABAssetBuildMgr.E_ABBUNLDE_TYPE.E_GAMEDATA:
			return 3;
		case ABAssetBuildMgr.E_ABBUNLDE_TYPE.E_FONT:
			return 13;
		case ABAssetBuildMgr.E_ABBUNLDE_TYPE.E_SOUND:
			return 12;
		case ABAssetBuildMgr.E_ABBUNLDE_TYPE.E_WEAPON:
			return 15;
		case ABAssetBuildMgr.E_ABBUNLDE_TYPE.E_GEM:
			return 16;
		}
