...
namespace Proto
{
	public class TError
	{
		...
		public static string getErrorString(TError.ErrorType errorCode)
		{
			//int num = (int)(TError.ErrorType.TDR_ERR_SHORT_BUF_FOR_WRITE * errorCode);
			//bool flag = 0 > num || num >= TError.errorTab.GetLength(0);
			string result = "";
			//if (flag)
			//{
			//	result = TError.errorTab[0];
			//}
			//else
			//{
			//	result = TError.errorTab[num];
			//}
			return result;
		}
	}
