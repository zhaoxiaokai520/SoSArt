...
public class CUtilList<T> : CUtilListBase, IEnumerable, IEnumerable<T>
{
	...
	{
		return this.Context.BinarySearch(item, new CUtilList<T>.ComparerConverter(comparer));
	}
	...
	{
		this.Context.Sort(new CUtilList<T>.ComparerConverter(comparer));
	}

	public void Sort(Comparison<T> comparison)
	{
		this.Context.Sort(new CUtilList<T>.ComparisonConverter(comparison));
	}

	public CUtilList<T>.Enumerator GetEnumerator()
	{
		return new CUtilList<T>.Enumerator(this.Context);
	}
}
